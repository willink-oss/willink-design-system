...
### Components shipped (npmjs.org public・42 components)
...
#### v1.9.0 additions (3 components)

| Component | API / Notes | Headless |
|---|---|---|
| `Command` | command palette / fuzzy-search menu (Input / List / Empty / Group / Item / Separator / Shortcut)・typeahead-filtered keyboard list | cmdk |
| `NavigationMenu` | site-level nav (List / Item / Trigger / Content / Link / Viewport / Indicator)・disclosure panels + `navigationMenuTriggerStyle` ghost pill | Radix NavigationMenu |
| `Menubar` | desktop-app menubar (Menu / Trigger / Content / Item / CheckboxItem / RadioItem / Sub / Separator / Label / Shortcut)・persistent horizontal menu set | Radix Menubar |
