...
- **v1.5** 🚧 Dark-mode consumer rollout — **partial**（clublink-platform は production 済み 2026-06-12: computed-style probe 24/24・blue×dark composition 検証済み。i-willink.com は実装完了・CI green、[PR #269](https://github.com/i-Willink-LLC/i-willink.com/pull/269) の CEO design sign-off 待ち = merge で production。DS 側 release はこの cycle 不要 — rollout が v1.2 の仕組みを消費。1.4.1 は rollout 発の臨時 PATCH）: [`docs/roadmap/v1.5.md`](./docs/roadmap/v1.5.md)
