...
### 1. install (GitHub Packages registry)

```bash
# .npmrc (project root)
echo '@willink-labs:registry=https://npm.pkg.github.com' >> .npmrc
...
### Phase 1 — components shipped (v0.2.1・public access)
...
- **Phase 1** ✅ shadcn 拡張 7 コンポーネント + GitHub Packages publish (v0.2.1 / 2026-05-08・public access)
